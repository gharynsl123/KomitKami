...
<div class="d-flex justify-content-between">
    <h4>Daftar Permintaan Material Produksi</h4>
    <a href="{{url('/show-all/permintaan')}}" class="btn btn-primary">Show All</a>
</div>
<div class="card p-3">
    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex">
            ...
            @endif
            <p class="fw-bolder badge badge-dot bg-info">{{ $groupedMaterials->first()->persetujuan ?? 'Belum ada status' }}</p>
        </div>
    </div>
